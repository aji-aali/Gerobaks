...
import 'package:bank_sha/blocs/wilayah/wilayah_event.dart';
import 'package:bank_sha/blocs/wilayah/wilayah_state.dart';
...
class WilayahBloc extends Bloc<WilayahEvent, WilayahState> {
  WilayahBloc() : super(WilayahState.initial()) {
